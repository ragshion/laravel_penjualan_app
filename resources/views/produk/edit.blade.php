                                ...
                                <div id="panel-1" class="panel">
                                    ...
                                    <div class="panel-container show">
                                        <div class="panel-content">
                                            @include('alert.error')
                                            <form method="post" action="{{route('produk.update',$produk->kd_produk)}}" autocomplete="off" enctype="multipart/form-data">
                                            @csrf
                                            {{method_field('put')}}
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control select2" id="kd_kategori" name="kd_kategori">
                                                        ...
                                                        <option value="{{$row->kd_kategori}}" @if($row->kd_kategori == $produk->kd_kategori) selected @endif>{{$row->kategori}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="number" name="harga" id="harga" class="form-control" placeholder="Harga" value="{{ $produk->harga }}">
                                                    </div>
                                                </div>
                                                <div class="form-group">
